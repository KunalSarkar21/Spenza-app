...
import { Lock, ArrowRight, DollarSign, CheckCircle2, Eye, EyeOff } from "lucide-react";
...
export function ResetPassword() {
  ...
  // Get the secret code Firebase puts in the URL
  ...
  // When the page loads, verify the code is valid and get the user's email
  useEffect(() => {
    if (!actionCode) {
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 hidden md:flex">
          ...
          >
            ...
            <p className="text-slate-400 text-lg max-w-md">
              Securely update your password to get back to tracking your financial future.
            </p>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-3xl shadow-2xl p-6 border border-slate-700 min-h-[400px] flex flex-col justify-center">
              ...
              <AnimatePresence mode="wait">
                {isVerifying ? (
                  <motion.div key="verifying" className="text-center text-slate-400 py-8">
                  ...
                  >
                    ...
                    <Link to="/login" className="w-full">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-medium flex items-center justify-center gap-2"
                      >
                    ...
                    <div className="mb-6">
                      ...
                      {email && (
                        <p className="text-slate-400 text-center text-sm">
                          for <span className="font-medium text-slate-300">{email}</span>
                        </p>
                      )}
                    </div>
